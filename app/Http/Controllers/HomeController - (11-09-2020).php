...
class HomeController extends Controller
{
	...
	public function summary(Request $request,$booking_id = null,$step = null)
    {
		if(!empty($booking_id))
		{
			...
			return view('booking.summary',compact('services','booking','booking_location','booking_dates','booking_form_truck','categories','equipments','presets','question','item_images','ranking','items','selected_items','time_charges','calender','insuranceCategories','PropertyInsurance'));	
		...
		else
		{
			if(!empty($booking_id))
			{
				...
				elseif($booking->step == 5)
				{
					...
					return view('booking.shop', compact('services','booking','booking_location','items','item_images','selected_items','selected_item_answers','question','ranking','presets','equipments','categories','search','available_trucks','booking_form_truck'));
				}
