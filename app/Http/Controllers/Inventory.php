...
{
    protected $fillable = ['name','meterial','category_id','equipments','weight','width','height','breadth','volume','R_A','R_B','R_C','R_D','R_E','ranking_id','ranking_time','stair_windy','stair_narrow', 'stair_wide', 'stair_spiral', 'elevator_passenger', 'elevator_freight', 'elevator_reserved_freight', 'time_0_min','time_0_med','time_0_max','time_1_min','time_1_med','time_1_max','time_2_min','time_2_med','time_2_max','time_3_min','time_3_med','time_3_max','time_4_min','time_4_med','time_4_max','time_5_min','time_5_med','time_5_max','time_6_min','time_6_med','time_6_max'];
