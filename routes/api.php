...
Route::get('/services_test','UserApiController@services_test');


Route::post('/signup' , 'UserApiController@signup');
Route::post('/refer_token' , 'UserApiController@refer_token');
...
{
	Route::post('/job_available' , 'UserApiController@job_available');
	Route::post('/job_assigned' , 'UserApiController@job_assigned');
	Route::post('/job_today' , 'UserApiController@job_today');
	Route::post('/job_accept' , 'UserApiController@job_accept');
	Route::post('/invite_helper' , 'UserApiController@invite_helper');
	Route::post('/invite_technician' , 'UserApiController@invite_technician');
	Route::post('/driver_details' , 'UserApiController@driver_details');
	Route::post('/helper_details' , 'UserApiController@helper_details');
	Route::post('/technician_details' , 'UserApiController@technician_details');
	Route::post('/job_schedule' , 'UserApiController@job_schedule');
	Route::post('/check_in' , 'UserApiController@check_in');
	Route::post('/check_out' , 'UserApiController@check_out');
	Route::post('/payment_info' , 'UserApiController@payment_info');
	Route::post('/refer_user' , 'UserApiController@refer_user');
	Route::post('/payment_claim' , 'UserApiController@payment_claim');
	Route::post('/job_opportunity' , 'UserApiController@job_opportunity');
});
