  ...
  <div class="tab-pane fade show  @if($i==0) active @endif" id="home_{{$i}}" role="tabpanel" aria-labelledby="home-tab{{$i}}">
  	...
  	<div class="card">
				...
				<div class="row">
					...
					<div id="div_floor_{{$i}}" class="col-md-4 mb-4 animated fadeIn delay-0-2s">
						<div class="card card-body border-warning shadow">
					...
					<div id="div_zip_code_{{$i}}" class="col-md-4 mb-4 animated fadeIn delay-0-3s" @if(empty($booking_location[$i]->zip_code)) style="display:none;" @endif>
						<div class="card card-body border-warning shadow">	
					...
					<div id="div_stair_kind_{{$i}}" class="col-md-4 mb-4 animated fadeIn delay-0-4s" @if(empty($booking_location[$i]->stair_kind)) style="display:none;" @endif>
						<div class="card card-body border-warning shadow">
					...
					<div id="div_stair_loc_{{$i}}" class="col-md-4 mb-4" @if(empty($booking_location[$i]->stair_loc)) style="display:none;" @endif>
						<div class="card card-body border-warning shadow animated fadeIn delay-0-5s">	
					...
					<div id="div_stair_type_{{$i}}" class="col-md-4 mb-4" @if(empty($booking_location[$i]->stair_type)) style="display:none;" @endif>
						<div  class="card card-body border-warning shadow animated fadeIn delay-0-5s">	
					...
					<div id="div_flights_{{$i}}" class="col-md-4 mb-4" @if(empty($booking_location[$i]->flights)) style="display:none;" @endif>
						<div  class="card card-body border-warning shadow animated fadeIn delay-0-6s">	
					...
					<div id="div_evelator_type_{{$i}}" class="col-md-4 mb-4" @if(empty($booking_location[$i]->evelator_type)) style="display:none;" @endif>
						<div class="card card-body border-warning shadow animated fadeIn delay-0-5s">	
					...
					<div id="div_parking_{{$i}}" class="col-md-4 mb-4"  @if(empty($booking_location[$i]->parking)) style="display:none;" @endif>
						<div class="card card-body border-warning shadow animated fadeIn delay-0-7s">
