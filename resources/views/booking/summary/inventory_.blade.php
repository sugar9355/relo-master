...
@foreach($selected_items as $k => $added_item )
  ...
  <div class="card  mr-3 ">
	<a href="item-1.jpg" class="p-0 m-0 text-center">
	  <img src="{{$added_item->file_path}}" width="120px" height="100px" alt="">
	</a>
	<div class="card-body bg-light text-center p-0">      
	  <small class="py-2 d-block">{{$added_item->item_name}}</small>
	  <div class="btn-group d-block" role="group">
		<form class="m-0 row w-100" id="ajaxform{{$added_item->item_id}}" action="/booking/162" method="post" enctype="multipart/form-data">
