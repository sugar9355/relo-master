<!-- Modal -->
<div id="celender" class="modal fade" role="dialog">
  <div class="modal-dialog" role="document">
	...
	<div id="div_calendar" class="modal-body text-center text-dark">
	...
	<div class="row">
		...
		<div class="row justify-content-center">
			...
			<div id="price_slider_{{$month}}_{{$day[0]}}" class="card card-body mt-2 p-2" style="display:none;">
				<div class="row m-0">
