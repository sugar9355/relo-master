...
@for($i=0; $i<=10; $i++) 
	...
	<div id="slider_{{$i}}" class="card card-body hvr-shadow mb-2 w-100 hvr-icon-bob rounded-lg" @if(isset($booking_dates[$i]->booking_date)) @else style="display:none;" @endif>	
	<div class="row">
		<div class="col-md-2 hvr-icon">
