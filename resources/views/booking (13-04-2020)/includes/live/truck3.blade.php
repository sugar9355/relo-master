		...
		<div class="card">
			...
			<div class="btn-group w-100" role="group">
				<button  class="btn btn-warning btn-sm text-white" type="button" data-toggle="modal" data-target="#quantity_{{ $added_item->booking_item_id }}"><i class="far fa-edit"></i></button>
		...
		@include('booking.includes.item_quantity')
