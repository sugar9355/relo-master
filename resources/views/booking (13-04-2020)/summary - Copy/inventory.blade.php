...
<table class="table">
  ...
  <tbody>
	...
	<tr>
	  <td><img class="shadow" src="{{$added_item->file_path}}" height="50" width="50" alt=""></td>
	  <td><p>{{$added_item->item_name}}</p></td>
	  <td>{{$added_item->quantity}}</td>
	  <td class="text-center"><a class="text-dark" href="#" data-toggle="modal" data-target="#item_info_{{ $added_item->booking_item_id }}"><i class="icon-eye text-info"></i></a></td>
	  <td class="text-center"><a class="text-dark" href="/booking/{{ ($booking->booking_id) ?: null }}/6" ><i class="icon-pencil3 text-primary"></i></a></td>
