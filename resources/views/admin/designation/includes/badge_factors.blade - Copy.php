...
<button type="button" style="margin-left: 1em;" class="btn btn-primary pull-right" data-toggle="modal" data-target="#badge_factor">Badges Factors</button>

<!-- Modal -->
<div id="badge_factor" class="modal fade" role="dialog">
