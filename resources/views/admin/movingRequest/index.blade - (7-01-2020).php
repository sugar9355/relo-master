                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu">
                                    <a href="{{ route('admin.user_request.show', $request->id) }}" class="dropdown-item">
                                        <i class="fa fa-search"></i> More Details
                                    </a>
                                    @if($request->status != 'SAVE' && $request->status != 'COMPLETED')
                                        <a href="{{ route('admin.user_request.edit', $request->id) }}" class="dropdown-item">
                                            <i class="fa fa-edit"></i> Update
                                        </a>
                                    @endif
                                    @if($request->status != 'COMPLETED')
                                        <a href="{{ route('admin.user_request.editOrder', $request->id) }}" class="dropdown-item">
...
@section('scripts')
    <script>
        ...
        function sendMessage() {
	        ...
	        axios.post('/admin/user_request/send_message', data).then( (response) => {
        ...
        function sendEmail() {
	        ...
	        uploader.val(null);
	        let url = '/admin/user_request/send_email';
