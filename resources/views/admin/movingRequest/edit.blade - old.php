                                    ...
                                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel"
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <label for="end" class="col-md-12 col-form-label">Difficulty Level</label>
                                                    <div class="col-md-12">
                                                        {{ $request->status }}
                                                    </div>
                                                </div>
								 ...
								 <div class="panel panel-default">
                                    ...
                                    <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                        <div class="panel-body">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label for="mileage" class="col-md-12 col-form-label">Truck Name</label>
                                                    <div class="col-md-12">@if(isset($assigned_truck)){{$assigned_truck->name}}@endif</div>
                                                </div>
                                            </div>
											<div class="col-md-2">
                                                <div class="form-group">
                                                    <label for="mileage" class="col-md-12 col-form-label">Truck Type</label>
                                                    <div class="col-md-12">@if(isset($assigned_truck)){{$assigned_truck->type}}@endif</div>
                                                </div>
                                            </div>
											<div class="col-md-2">
                                                <div class="form-group">
                                                    <label for="mileage" class="col-md-12 col-form-label">Truck Color</label>
                                                    <div class="col-md-12">@if(isset($assigned_truck)) {{$assigned_truck->color}} @endif</div>
                                                </div>
                                            </div>
											<div class="col-md-2">
                                                <div class="form-group">
                                                    <label for="mileage" class="col-md-12 col-form-label">Truck Volume</label>
                                                    <div class="col-md-12">@if(isset($assigned_truck)){{$assigned_truck->volume}}@endif</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
