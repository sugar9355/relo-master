...
<div class="card">
    <div class="card-body">
            ...
            <a href="{{ route('admin.worker.index') }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> @lang('admin.back')</a>

			<h5 style="margin-bottom: 2em;">Add Worker</h5>

            <form class="form-horizontal" action="{{route('admin.worker.store')}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
...
<div class="form-group">
				...
				<div class="form-group col-md-12 d-flex mb-0 justify-content-center">
						<div class="form-group col-md-2 text-center mb-0"><strong>Monday</strong></div> 
						<div class="form-group col-md-2 text-center mb-0"><strong>Tuesday</strong></div> 
						<div class="form-group col-md-2 text-center mb-0"><strong>Wednesday</strong></div> 
						<div class="form-group col-md-2 text-center mb-0"><strong>Thursday</strong></div> 
						<div class="form-group col-md-2 text-center mb-0"><strong>Friday</strong></div> 
						<div class="form-group col-md-2 text-center mb-0"><strong>Saturday</strong></div> 
						<div class="form-group col-md-2 text-center mb-0"><strong>Sunday</strong></div> 
				</div>
				<div class="form-group col-md-12 d-flex mb-0 justify-content-center">
