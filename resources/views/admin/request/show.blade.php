            ...
            <div class="row">
                <div class="col-md-6">
                    <dl class="row">
                        ...
                        <dd class="col-sm-8">
                            @if($request->schedule_at != "0000-00-00 00:00:00"  && $request->schedule_at != "")
                        ...
                        <dd class="col-sm-8">
                            @if($request->started_at != "0000-00-00 00:00:00" && $request->started_at != "")
                        ...
                        <dd class="col-sm-8">
                            @if($request->finished_at != "0000-00-00 00:00:00"  && $request->finished_at != "") 
