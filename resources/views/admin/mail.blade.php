...
<option value="other">Other</option>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="{{url('admin/edit-template')}}/{{$value->id}}" >Edit</a></td>
    </tr>
    @endforeach
    @endif
          ...
          if (form.checkValidity() === false) {
            ...
            var tempidd = $('#templateid').val()!='other'?$('#templateid').val():$('#otheroption').val()
                $.ajax({
                  ...
                  data: {'temp_id':tempidd,'fromemail':$('#fromemail').val(),'subject':$('#subject').val(),'template_value':CKEDITOR.instances.mailtemplate.getData()},
