	...
	<div class="navbar navbar-expand-md navbar-dark">
		<div class="navbar-brand d-flex">
			<a href="index.html" class="d-inline-block">
				<img src="{{asset('assets_admin/images/logo.png')}}" alt=""> 
			</a><span class="h1 mt-1">RELO</span>
		</div>
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown">
					<a href="#" class="navbar-nav-link dropdown-toggle caret-0" data-toggle="dropdown">
						@php 
							use App\DB;
							$notification = App\BookingNotify::getNotify();
						@endphp
						
						<i class="icon-magazine"></i>
						<span class="d-md-none ml-2">Notification</span>
						<span class="badge badge-pill bg-warning-400 ml-auto ml-md-0">@php echo count($notification); @endphp</span>
					</a>
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-350">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-8 col-sm-8 col-8">
                          	<a href="'.url('admin/booking_detail/'.$notification[$key]->booking_id).'" >
                            <strong class="text-info">'.$notification[$key]->fullname.'</strong>
                            </a>
                            <div>
                             '.$notification[$key]->email.'
                            </div>
                            <div>
                             '.$notification[$key]->mobile_no.'
                            </div>
                          </div></div> </li>';
                   		 }
