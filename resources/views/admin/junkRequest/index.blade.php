...
<div class="card">
    <div class="card-body">
        <div >
            <h5 class="mb-1">Junk Request History</h5>
            @if(count($requests) != 0)
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu">
                                    <a href="{{ route('admin.user_junk_request.show', $request->id) }}" class="dropdown-item">
                                        <i class="fa fa-search"></i> More Details
                                    </a>
                                    @if($request->status != 'SAVE' && $request->status != 'COMPLETED')
                                        <a href="{{ route('admin.user_junk_request.edit', $request->id) }}" class="dropdown-item">
                                            <i class="fa fa-edit"></i> Update
                                        </a>
                                    @endif
                                    @if($request->status != 'COMPLETED')
                                        <a href="{{ route('admin.user_junk_request.editOrder', $request->id) }}" class="dropdown-item">
