    ...
    <div class="card">
        <div class="card-body">
            <div >
                ...
                <h5 style="margin-bottom: 2em;">@lang('admin.vehicle.Add_Zone_Type')</h5>

                <form class="form-horizontal" action="{{route('admin.zone_type.store')}}" method="POST" enctype="multipart/form-data" role="form">
                    {{csrf_field()}}
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-md-6">
                                <input class="form-control" type="text" value="{{ old('sh_price') }}" name="sh_price" id="sh_price" placeholder="Input Amount">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-1">
                            <input class="form-control" type="color" value="{{ (old('color')) ? old('color') : '#000000'}}" name="color" required id="color" placeholder="Color" style="height: 40px">
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="form-group">
                        <hr>
                        <div class="col-md-10">
                            <button type="submit" class="btn btn-primary">@lang('admin.vehicle.Add_Zone_Type')</button>
