                        ...
                        <div class="row" id="flights-box-{{$j}}">
                            ...
                            <div class="col-6">
                                <div class="row">
                                    ...
                                    <div class="form-group col-2 small-move">
                                        ...
                                        <input class="form-control text-right" type="text" value="{{isset($flights_min[$j][$i][$k]) ? $flights_min[$j][$i][$k] : 0}}" name="flights_min[{{$j}}][{{$i}}][{{$k}}]" id="flights_min_{{$j}}_{{$i}}_{{$k}}"@if (!isset($flights_min[$j]))readonly @endif />
                                    </div>
                                    <div class="form-group col-2 small-move">
                                        <label>Med Time</label>
                                        <input class="form-control text-right" type="text" value="{{isset($flights_med[$j][$i][$k]) ? $flights_med[$j][$i][$k] : 0}}" name="flights_med[{{$j}}][{{$i}}][{{$k}}]" id="flights_med_{{$j}}_{{$i}}_{{$k}}"@if (!isset($flights_min[$j]))readonly @endif />
                                    </div>
                                    <div class="form-group col-2 small-move">
                                        <label>Max Time</label>
                                        <input class="form-control text-right" type="text" value="{{isset($flights_max[$j][$i][$k]) ? $flights_max[$j][$i][$k] : 0}}" name="flights_max[{{$j}}][{{$i}}][{{$k}}]" id="flights_max_{{$j}}_{{$i}}_{{$k}}"@if (!isset($flights_min[$j]))readonly @endif />
                                    </div>
                                    @if ($j == 2)
                            ...
                            <div class="col-6">
                                <div class="row">
                                    ...
                                    <div class="form-group col-2 small-move">
                                        <label>Min Time</label>
                                        <input class="form-control text-right" type="text" value="{{isset($flights_min[$j][7][$k]) ? $flights_min[$j][7][$k] : 0}}" name="flights_min[{{$j}}][{{7}}][{{$k}}]" id="flights_min_{{$j}}_{{7}}_{{$k}}"@if (!isset($flights_min[$j]))readonly @endif />
                                    </div>
                                    <div class="form-group col-2 small-move">
                                        <label>Med Time</label>
                                        <input class="form-control text-right" type="text" value="{{isset($flights_med[$j][7][$k]) ? $flights_med[$j][7][$k] : 0}}" name="flights_med[{{$j}}][{{7}}][{{$k}}]" id="flights_med_{{$j}}_{{7}}_{{$k}}"@if (!isset($flights_min[$j]))readonly @endif />
                                    </div>
                                    <div class="form-group col-2 small-move">
                                        <label>Max Time</label>
                                        <input class="form-control text-right" type="text" value="{{isset($flights_max[$j][7][$k]) ? $flights_max[$j][7][$k] : 0}}" name="flights_max[{{$j}}][{{7}}][{{$k}}]" id="flights_max_{{$j}}_{{7}}_{{$k}}"@if (!isset($flights_min[$j]))readonly @endif />
                                    </div>
                                    @if ($j == 2)
                                    <div class="form-group col-3 sh-move">
                                    </div>
                        ...
                        <div class="row" id="passenger-box-{{$j}}">
                            ...
                            <div class="col-6">
                                <div class="row">
                                    ...
                                    <div class="form-group col-3 small-move">
                                        ...
                                        <input class="form-control text-right" type="text" value="{{isset($passenger_time[$j][$i][$k]) ? $passenger_time[$j][$i][$k] : 0}}" name="passenger_time[{{$j}}][{{$i}}][{{$k}}]" id="passenger_time_{{$j}}_{{$i}}_{{$k}}"@if (!isset($flights_min[$j]))readonly @endif />
                                    </div>
                                    <div class="form-group col-3 small-move">
                                        <label>Additional Delay</label>
                                        <input class="form-control text-right" type="text" value="{{isset($passenger_delay[$j][$i][$k]) ? $passenger_delay[$j][$i][$k] : 0}}" name="passenger_delay[{{$j}}][{{$i}}][{{$k}}]" id="passenger_delay_{{$j}}_{{$i}}_{{$k}}"@if (!isset($flights_min[$j]))readonly @endif />
                                    </div>
                                    @if ($j == 2)
                                    <div class="form-group col-3 sh-move">
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="row">
                                    ...
                                    <div class="form-group col-3 small-move">
                                        <label>Required Time</label>
                                        <input class="form-control text-right" type="text" value="{{isset($passenger_time[$j][7][$k]) ? $passenger_time[$j][7][$k] : 0}}" name="passenger_time[{{$j}}][{{7}}][{{$k}}]" id="passenger_time_{{$j}}_{{7}}_{{$k}}"@if (!isset($flights_min[$j]))readonly @endif />
                                    </div>
                                    <div class="form-group col-3 small-move">
                                        <label>Additional Delay</label>
                                        <input class="form-control text-right" type="text" value="{{isset($passenger_delay[$j][7][$k]) ? $passenger_delay[$j][7][$k] : 0}}" name="passenger_delay[{{$j}}][{{7}}][{{$k}}]" id="passenger_delay_{{$j}}_{{7}}_{{$k}}"@if (!isset($flights_min[$j]))readonly @endif />
                                    </div>
                                    @if ($j == 2)
                                    <div class="form-group col-3 sh-move">
                                    </div>
                        ...
                        <div class="row" id="freight-box-{{$j}}">
                            ...
                            <div class="col-6">
                                <div class="row">
                                    ...
                                    <div class="form-group col-3 small-move">
                                        <label>Required Time</label>
                                        <input class="form-control text-right" type="text" value="{{isset($freight_time[$j][$i][$k]) ? $freight_time[$j][$i][$k] : 0}}" name="freight_time[{{$j}}][{{$i}}][{{$k}}]" id="freight_time_{{$j}}_{{$i}}_{{$k}}"@if (!isset($flights_min[$j]))readonly @endif />
                                    </div>
                                    <div class="form-group col-3 small-move">
                                        <label>Additional Delay</label>
                                        <input class="form-control text-right" type="text" value="{{isset($freight_delay[$j][$i][$k]) ? $freight_delay[$j][$i][$k] : 0}}" name="freight_delay[{{$j}}][{{$i}}][{{$k}}]" id="freight_delay_{{$j}}_{{$i}}_{{$k}}"@if (!isset($flights_min[$j]))readonly @endif />
                                    </div>
                                    @if ($j == 2)
                                    <div class="form-group col-3 sh-move">
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="row">
                                    ...
                                    <div class="form-group col-3 small-move">
                                        <label>Required Time</label>
                                        <input class="form-control text-right" type="text" value="{{isset($freight_time[$j][7][$k]) ? $freight_time[$j][7][$k] : 0}}" name="freight_time[{{$j}}][{{7}}][{{$k}}]" id="freight_time_{{$j}}_{{7}}_{{$k}}"@if (!isset($flights_min[$j]))readonly @endif />
                                    </div>
                                    <div class="form-group col-3 small-move">
                                        <label>Additional Delay</label>
                                        <input class="form-control text-right" type="text" value="{{isset($freight_delay[$j][7][$k]) ? $freight_delay[$j][7][$k] : 0}}" name="freight_delay[{{$j}}][{{7}}][{{$k}}]" id="freight_delay_{{$j}}_{{7}}_{{$k}}"@if (!isset($flights_min[$j]))readonly @endif />
                                    </div>
                                    @if ($j == 2)
                                    <div class="form-group col-3 sh-move">
                                    </div>
                        ...
                        <div class="row" id="rs_freight-box-{{$j}}">
                            ...
                            <div class="col-6">
                                <div class="row">
                                    ...
                                    <div class="form-group col-3 small-move">
                                        <label>Required Time</label>
                                        <input class="form-control text-right" type="text" value="{{isset($rs_freight_time[$j][$i][$k]) ? $rs_freight_time[$j][$i][$k] : 0}}" name="rs_freight_time[{{$j}}][{{$i}}][{{$k}}]" id="rs_freight_time_{{$j}}_{{$i}}_{{$k}}"@if (!isset($flights_min[$j]))readonly @endif />
                                    </div>
                                    <div class="form-group col-3 small-move">
                                        <label>Additional Delay</label>
                                        <input class="form-control text-right" type="text" value="{{isset($rs_freight_delay[$j][$i][$k]) ? $rs_freight_delay[$j][$i][$k] : 0}}" name="rs_freight_delay[{{$j}}][{{$i}}][{{$k}}]" id="rs_freight_delay_{{$j}}_{{$i}}_{{$k}}"@if (!isset($flights_min[$j]))readonly @endif />
                                    </div>
                                    @if ($j == 2)
                                    <div class="form-group col-3 sh-move">
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="row">
                                    ...
                                    <div class="form-group col-3 small-move">
                                        <label>Required Time</label>
                                        <input class="form-control text-right" type="text" value="{{isset($rs_freight_time[$j][7][$k]) ? $rs_freight_time[$j][7][$k] : 0}}" name="rs_freight_time[{{$j}}][{{7}}][{{$k}}]" id="rs_freight_time_{{$j}}_{{7}}_{{$k}}"@if (!isset($flights_min[$j]))readonly @endif />
                                    </div>
                                    <div class="form-group col-3 small-move">
                                        <label>Additional Delay</label>
                                        <input class="form-control text-right" type="text" value="{{isset($rs_freight_delay[$j][7][$k]) ? $rs_freight_delay[$j][7][$k] : 0}}" name="rs_freight_delay[{{$j}}][{{7}}][{{$k}}]" id="rs_freight_delay_{{$j}}_{{7}}_{{$k}}"@if (!isset($flights_min[$j]))readonly @endif />
                                    </div>
                                    @if ($j == 2)
                                    <div class="form-group col-3 sh-move">
                                    </div>
