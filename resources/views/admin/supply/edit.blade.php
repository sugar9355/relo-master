...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form class="form-horizontal" action="{{route('admin.supply.update', $supply->id)}}" method="POST" enctype="multipart/form-data" role="form">
            {{csrf_field()}}
            ...
            <div class="row">
                <div class="col-2 pl-3 form-group">
                    ...
                    <input class="form-control" type="text" name="name" id="name" required value="{{$supply->name}}">
                </div>
            </div>
            <div class="row">
                <div class="col-2 pl-3 form-group">
                    <label class="mt-1">Cost Per (<span id="packing_name">{{$supply->name}}</span>)</label>
                    <input class="form-control" type="text" name="cost" id="cost" required value="{{$supply->cost}}">
                </div>
            </div>
