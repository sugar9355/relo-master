    ...
    <div class="card">
        <div class="card-body">
            <div >
                ...
                <div class="row">
                    <form class="form-horizontal" id="updateOrderForm" action="{{ route('admin.user_request.updateOrder', $request->id    ) }}"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="floor" class="form-control" value="{{ $request->locations->first()->stair_type }}"
                                           disabled>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="floor" class="form-control" value="{{ $request->locations->first()->elevator_type }}"
                                           disabled>
                                </div>
                                <div class="col-md-6">
                                    <label for="start" class="col-form-label">Detailed Address</label>
                                    <input type="text" id="floor" class="form-control" value="{{ $request->locations->first()->detail_address }}"
                                           disabled>
                                </div>
                            </div>
                            ...
                            @foreach(json_decode($request->waypoints) as $index => $locations)
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <label for="floor" class="col-form-label">Floor</label>
                                        <input type="text" id="floor" class="form-control" value="{{ $request->locations[$index+1]->floor }}"
                                               disabled>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6">
                                        <label for="floor" class="col-form-label">Zip Code</label>
                                        <input type="text" id="floor" class="form-control" value="{{ $request->locations[$index+1]->zip_code }}"
                                               disabled>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="start" class="col-form-label">How will the movers be moving the furniture?</label>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        <label for="floor" class="col-form-label">What kind of stairs are they?</label>
                                        <input type="text" id="floor" class="form-control" value="{{ $request->locations[$index+1]->stair_type }}"
                                               disabled>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="start" class="col-form-label">how many flights are there ?</label>
                                        <input type="text" id="floor" class="form-control" value="{{ $request->locations[$index+1]->flight }}"
                                               disabled>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6">
                                        <label for="floor" class="col-form-label">What kind of elevator will they be using?</label>
                                        <input type="text" id="floor" class="form-control" value="{{ $request->locations[$index+1]->elevator_type }}"
                                               disabled>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="start" class="col-form-label">Detailed Address</label>
                                        <input type="text" id="floor" class="form-control" value="{{ $request->locations[$index+1]->detail_address }}"
                                               disabled>
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    <label for="floor" class="col-form-label">What kind of elevator will they be using?</label>
                                    <input type="text" id="floor" class="form-control" value="{{ $request->locations->last()->elevator_type }}"
                                           disabled>
                                </div>
                                <div class="col-md-6">
                                    <label for="start" class="col-form-label">Detailed Address</label>
                                    <input type="text" id="floor" class="form-control" value="{{ $request->locations->last()->detail_address }}"
                                           disabled>
                                </div>
                            </div>
                            <div id="item">
                                @foreach($request->userMovingRequestItems as $itemIndex => $item)
                                    <div class="form-group row item{{ $itemIndex }}" style="border-top: 1px solid #000;">
                                                    ...
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            ...
                                                            <input type="radio" class="form-check-input"
                                                                   name="answer_{{ $itemIndex.'_'.$questionIndex }}"
                                                                   value="{{ $question->id }}_{{ $answer->title }}" {{ $active }}> {{ $answer->title }}
                                                        </label>
                                                    </div>
                                                @endforeach
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="floor" name="additional_information[]" class="form-control"
                                                   value="{{ $cartOptions->additional_info }}">
                                        </div>
                                        <div class="col-md-6">
