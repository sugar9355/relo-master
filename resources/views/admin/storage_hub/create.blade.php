    ...
    <div class="card">
        <div class="card-body">
            <div >
                ...
                <form class="form-horizontal" action="{{route('admin.storage_hub.store')}}" method="POST" enctype="multipart/form-data" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="{{ old('day') }}" name="day" required id="day" placeholder="100">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="{{ old('week') }}" name="week" required id="week" placeholder="100">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="{{ old('month') }}" name="month" required id="month" placeholder="100">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="{{ old('year') }}" name="year" required id="year" placeholder="100">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="{{ old('total_sq_feet') }}" name="total_sq_feet" required
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="{{ old('sq_feet') }}" name="sq_feet" required
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12 tg-list">
                            <div class="tg-list-item">
                                ...
                                <input class="tgl tgl-flat" name="time" onclick="changeLabel(this)" value="1" {{ (old('time')) ? 'checked' : null }} id="cb4" type="checkbox"/>
                    ...
                    <div id="myRoomsList">
                        <div id="room_1">
                            <div class="form-group">
                                <label for="room_name" class="col-md-12 col-form-label">Room 1 Name</label>
                                <div class="col-md-10">
                            ...
                            <div class="form-group">
                                <label for="room_sq" class="col-md-12 col-form-label">Room 1 Square Feet</label>
                                <div class="col-md-10">
