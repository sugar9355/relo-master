    	...
    	<div >
            ...
            <form class="form-horizontal" action="{{ route('admin.settings.store') }}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group">
					<label for="site_title" class="col-md-2 col-form-label">@lang('admin.setting.Site_Name')</label>
					<div class="col-md-10">
				...
				<div class="form-group">
					<label for="site_logo" class="col-md-2 col-form-label">@lang('admin.setting.Site_Logo')</label>
					<div class="col-md-10">
				...
				<div class="form-group">
					<label for="site_icon" class="col-md-2 col-form-label">@lang('admin.setting.Site_Icon')</label>
					<div class="col-md-10">
                ...
                <div class="form-group">
                    <label for="tax_percentage" class="col-md-2 col-form-label">@lang('admin.setting.Copyright_Content')</label>
                    <div class="col-md-10">
				...
				<div class="form-group row" style="display:none">
					<label for="store_link_android" class="col-md-2 col-form-label">@lang('admin.setting.Playstore_link')</label>
					<div class="col-md-10">
				...
				<div class="form-group row" style="display:none">
					<label for="store_link_ios" class="col-md-2 col-form-label">@lang('admin.setting.Appstore_Link')</label>
					<div class="col-md-10">
				...
				<div class="form-group row" style="display:none">
					<label for="provider_select_timeout" class="col-md-2 col-form-label">@lang('admin.setting.Provider_Accept_Timeout')</label>
					<div class="col-md-10">
				...
				<div class="form-group row" style="display:none">
					<label for="provider_search_radius" class="col-md-2 col-form-label">@lang('admin.setting.Provider_Search_Radius')</label>
					<div class="col-md-10">
				...
				<div class="form-group row" style="display:none">
					<label for="sos_number" class="col-md-2 col-form-label">@lang('admin.setting.SOS_Number')</label>
					<div class="col-md-10">
				...
				<div class="form-group row" style="display:none">
					<label for="stripe_secret_key" class="col-md-2 col-form-label"> Manual Assigning </label>
					<div class="col-md-10">
				...
				<div class="form-group row" style="display:none">
					<label for="broadcast_request" class="col-md-2 col-form-label"> BroadCast Assigning </label>
					<div class="col-md-10">
				...
				<div class="form-group row" style="display:none">
					<label for="track_distance" class="col-md-2 col-form-label"> Track Live Travel Distance </label>
					<div class="col-md-10">
				...
				<div class="form-group">
					<label for="contact_number" class="col-md-2 col-form-label">@lang('admin.setting.Contact_Number')</label>
					<div class="col-md-10">
				...
				<div class="form-group">
					<label for="contact_email" class="col-md-2 col-form-label">@lang('admin.setting.Contact_Email')</label>
					<div class="col-md-10">
				...
				<div class="form-group row" style="display:none">
					<label for="social_login" class="col-md-2 col-form-label">@lang('admin.setting.Social_Login')</label>
					<div class="col-md-10">
				...
				<div class="form-group row" style="display:none">
					<label for="map_key" class="col-md-2 col-form-label">@lang('admin.setting.map_key')</label>
					<div class="col-md-10">
				...
				<div class="form-group row" style="display:none">
					<label for="fb_app_version" class="col-md-2 col-form-label">@lang('admin.setting.fb_app_version')</label>
					<div class="col-md-10">
				...
				<div class="form-group row" style="display:none">
					<label for="fb_app_id" class="col-md-2 col-form-label">@lang('admin.setting.fb_app_id')</label>
					<div class="col-md-10">
				...
				<div class="form-group row" style="display:none">
					<label for="fb_app_secret" class="col-md-2 col-form-label">@lang('admin.setting.fb_app_secret')</label>
					<div class="col-md-10">
