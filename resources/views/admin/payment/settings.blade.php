            ...
            <div >
                <form action="{{route('admin.settings.payment.store')}}" method="POST">
                    ...
                    <div class="card card-block card-inverse card-primary">
                        <blockquote class="card-blockquote">
                            ...
                            <div id="card_field" @if(Setting::get('CARD') == 0) style="display: none;" @endif>
                                <div class="form-group">
                                    <label for="stripe_secret_key" class="col-md-4 col-form-label">@lang('admin.payment.stripe_secret_key')</label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <label for="stripe_publishable_key" class="col-md-4 col-form-label">@lang('admin.payment.stripe_publishable_key')</label>
                                    <div class="col-md-8">
                    ...
                    <div class="card card-block card-inverse card-info">
                        <blockquote class="card-blockquote">
                            <div class="form-group">
                                <label for="daily_target" class="col-md-4 col-form-label">@lang('admin.payment.daily_target')</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <label for="tax_percentage" class="col-md-4 col-form-label">@lang('admin.payment.tax_percentage')</label>
                                <div class="col-md-8">
                                    <input class="form-control"
                                           type="number"
                            ...
                            <div class="form-group">
                                <label for="surge_trigger" class="col-md-4 col-form-label">@lang('admin.payment.surge_trigger_point')</label>
                                <div class="col-md-8">
                                    <input class="form-control"
                                           type="number"
                            ...
                            <div class="form-group">
                                <label for="surge_percentage" class="col-md-4 col-form-label">@lang('admin.payment.surge_percentage')</label>
                                <div class="col-md-8">
                                    <input class="form-control"
                                           type="number"
                            ...
                            <div class="form-group">
                                <label for="commission_percentage" class="col-md-4 col-form-label">@lang('admin.payment.commission_percentage')</label>
                                <div class="col-md-8">
                                    <input class="form-control"
                                           type="number"
                            ...
                            <div class="form-group">
                                <label for="provider_commission_percentage" class="col-md-4 col-form-label">@lang('admin.payment.provider_commission_percentage')</label>
                                <div class="col-md-8">
                                    <input class="form-control"
                                           type="number"
                            ...
                            <div class="form-group">
                                <label for="upfront_charge_percentage" class="col-md-4 col-form-label">@lang('admin.payment.upfront_charge_percentage')</label>
                                <div class="col-md-8">
                                    <input class="form-control"
                                           type="number"
                                           value="{{ Setting::get('upfront_charge_percentage', '0') }}"
                                           id="upfront_charge_percentage"
                                           name="upfront_charge_percentage"
                                           min="0"
                                           max="100"
                                           placeholder="Upfront Charge Percentage">
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="booking_prefix" class="col-md-4 col-form-label">@lang('admin.payment.booking_id_prefix')</label>
                                <div class="col-md-8">
                                    <input class="form-control"
                                           type="text"
                            ...
                            <div class="form-group">
                                <label for="base_price" class="col-md-4 col-form-label">@lang('admin.payment.currency')
                                ...
                                <div class="col-md-8">
                                    <select name="currency" class="form-control" required>
                                        ...
                                        <option @if(Setting::get('currency') == "PKR") selected @endif value="PKR"> Pakistani rupee (PKR)</option>
                                    </select>
                                </div>
                            </div>
                        </blockquote>
