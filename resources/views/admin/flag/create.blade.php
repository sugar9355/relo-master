...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form class="form-horizontal" action="{{route('admin.flag.store')}}" method="POST" enctype="multipart/form-data" role="form">
            {{csrf_field()}}
            ...
            <div class="row">
                <div class="col-md-1 pl-3">
                    ...
                    <span class="input-group-prepend">
                        <input name="color" type="color" class="form-control form-control-lg" style="height: 40px" required>
                    </span>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row item_options" id="item_option_box" style="display: none">
                <div class="col-md-6 pl-3">
                    <div class="form-group">
            ...
            <div class="row flights_options" id="num_flights_option_box" style="display: none">
                <div class="col-md-6 pl-3">
                    <div class="form-group">
            ...
            <div class="row flights_options" id="type_flights_option_box" style="display: none">
                <div class="col-md-6 pl-3">
                    <div class="form-group">
                        <label for="name" class="col-md-12 col-form-label">Number of Flights</label>
            ...
            <div class="row address_options" style="display: none">
                <div class="col-md-6 pl-3 mb-3 input-group">
                    <input type="text" name="addresses[0]" id="address_0" class="form-control address" placeholder="Address" style="width: 200px" />
                    <input type="number" name="apt[0]" id="apt_0" class="form-control" placeholder="Apt/Suite Number" value="0" />
                    <div class="input-group-append">
                        <button type="button" class="btn btn-sm btn-info" id="add_address" value="1" style="width: 100px">Add more</button>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 pl-3">
                    ...
                    <span class="input-group-prepend">
                        <input name="reason_title" type="text" class="form-control form-control-lg">
                    </span>
                </div>
            </div>
            <div class="row">
