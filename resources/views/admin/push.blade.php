            ...
            <div >
	            ...
	            <form class="form-horizontal" action="{{route('admin.send.push')}}" method="POST" role="form" id="create_push">
	            	...
	            	<div class="form-group">
						<label class="col-md-2 col-form-label">@lang('admin.push.Sent_to')</label>
						<div class="col-md-10">
					...
					<div class="form-group row" id="for_users" style="display: none;">
						<label class="col-md-2 col-form-label">User Conditions</label>
						<div class="col-md-5">
						...
						<div class="col-md-5" id="user_active" style="display: none;">
					...
					<div class="form-group row" id="for_providers" style="display: none;">
						<label class="col-md-2 col-form-label">Driver Conditions</label>
						<div class="col-md-5">
						...
						<div class="col-md-5" id="provider_active" style="display: none;">
						...
						<div class="col-md-5" id="provider_rides"  style="display: none;">
							<input type="number" class="form-control" name="provider_rides" placeholder="Number of Rides">
						</div>

						<div class="col-md-5" id="provider_amount" style="display: none;">
							<input type="number" class="form-control" name="provider_amount" placeholder="Amount Spent">
						</div>

						<div class="col-md-5" id="provider_location" style="display: none;">
					...
					<div class="form-group">
						<label for="message" class="col-md-2 col-form-label">@lang('admin.push.message')</label>
						<div class="col-md-10">
