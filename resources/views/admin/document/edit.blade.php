    	...
    	<div >
            ...
            <form class="form-horizontal" action="{{route('admin.document.update', $document->id )}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group">
					<label for="name" class="col-md-2 col-form-label">@lang('admin.document.document_name')</label>
					<div class="col-md-10">
                ...
                <div class="form-group">
                    <label for="name" class="col-md-2 col-form-label">@lang('admin.document.document_type')</label>
                    <div class="col-md-10">
                        <select name="type">
