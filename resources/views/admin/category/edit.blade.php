            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="{{$category->name}}" name="name" requaired id="name"  placeholder="Categroy Name" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <select name="equipment[]" id="equipment" multiple="multiple" class="form-control select" data-fouc>
                                        @php $c_equipment = explode(',',$category->equipments); @endphp
                                    @foreach($equipments as $equipment)
                                        <option value="{{ $equipment->id }}" @if(in_array($equipment->id,$c_equipment)) selected @endif >{{ $equipment->name }}</option>
                                    @endforeach
                                </select>
                            </select>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="form-check form-check-switch form-check-switch-left">
                                    <label class="form-check-label d-flex align-items-center">
                                        <input name="hoisting" value="1" type="checkbox" @if($category->hoisting == 1) checked @endif class="form-check-input form-check-input-switch" data-on-text="On" data-off-text="Off" data-on-color="success" data-off-color="danger" >
                                    </label>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">                
                            <div class="form-group">
                                ...
                                <select class="form-control" name="material" id="material_type">
                                    <option value="" selected hidden>Select Category</option>
                                @foreach($materials as $material)
                                    <option value="{{ $material->id }}" @if($material->id == $category->material)) selected @endif >{{ $material->name }}</option>
                                @endforeach
                            </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="flag" id="flag_{{$flag->id}}" value="{{$flag->id}}" @if ($flag->id == $category->flag) checked @endif>
                                ...
                                <div class="form-check form-check-switch form-check-switch-left">
                                    <label class="form-check-label d-flex align-items-center">
                                        <input name="stackable" type="checkbox" value="1" id="stackable"
                                            ...
                                            data-off-text="Unstackable" data-on-color="success" data-off-color="default" @if($category->stackable == 1)checked @endif/>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group stackable_mul_container" @if($category->stackable != 1)style="display: none" @endif>
                                ...
                                <input type="number" class="form-control col-md-6" name="stackable_multiplier" id="stackable_multiplier" step="0.01"
                                    value="{{isset($category->stackable_multiplier) ? $category->stackable_multiplier : 1}}" />
                            </div>
                        </div>
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    @foreach($category_questions as $k =>  $question)
                        <div class="form-group" id="div_{{$k+1}}">
                            <div class="row">
                                <div class="col-md-1 text-right"><span class="badge bg-teal p-2">Q. {{$k + 1}}</span></div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-3 form-check form-check-switch form-check-switch-left">
                                    <label class="form-check-label d-flex align-items-center">
                                        <input name="question_allow[{{$k+1}}]" value="1" type="checkbox" class="form-check-input form-check-input-switch" data-on-text="On" data-off-text="Off" data-on-color="success" data-off-color="danger" @if ($question->allow)checked @endif>
                                    </label>
                                </div>
                                <div class="col-md-2">
            ...
            <div class="row">
                <div class="form-group col-md-2">
                    ...
                    <select class="form-control" name="wrapping_material" id="wrapping_material">
                        ...
                        @foreach($materials as $material)
                        <option value="{{ $material->id }}"@if($material->id == $category->wrapping_material)) selected @endif>{{ $material->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-md-2">
                    <label for="wrapping_qty" class="col-form-label">Qty</label>
                    <input class="form-control" type="text" name="wrapping_qty" id="wrapping_qty" placeholder="Qty" value="{{$category->wrapping_qty}}" />
                </div>
                <div class="form-group col-md-2">
                    <label for="wrapping_time" class="col-form-label">Time to Wrap</label>
                    <input class="form-control" type="text" name="wrapping_time" id="wrapping_time" placeholder="Time to Wrap" value="{{$category->wrapping_time}}" />
                </div>
                <div class="form-group col-md-2">
                    <label for="wrapping_price" class="col-form-label">Price</label>
                    <input class="form-control" type="text" name="wrapping_price" id="wrapping_price" placeholder="Wrapping Price" value="{{$category->wrapping_price}}" />
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="form-group col-md-2 col-lg-1 text-center">
                    ...
                    <input class="form-control" type="text" name="weight_min" id="weight_min" placeholder="@lang('admin.weight')" value="{{$category->weight_min}}" />
                </div>
                <div class="form-group col-md-2 col-lg-1 text-center">
                    <label for="">@lang('admin.weight') Max</label>
                    <input class="form-control" type="text" name="weight_max" id="weight_max" placeholder="@lang('admin.weight')" value="{{$category->weight_max}}" />
                </div>
                <div class="form-group col-md-2 col-lg-1 text-center">
                    <label for="">@lang('admin.price') Min</label>
                    <input class="form-control" type="text" name="junk_price_min" id="junk_price_min" placeholder="Junk Price" value="{{$category->junk_price_min}}" />
                </div>
                <div class="form-group col-md-2 col-lg-1 text-center">
                    <label for="">@lang('admin.price') Max</label>
                    <input class="form-control" type="text" name="junk_price_max" id="junk_price_max" placeholder="Junk Price" value="{{$category->junk_price_max}}" />
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-2 col-lg-1 text-center">
                    <label for="">Price for Storage</label>
                    <input class="form-control" type="text" name="storage_price" id="storage_price" placeholder="Price for Storage" value="{{$category->storage_price}}" />
                </div>
            </div>
                <div class="row">
                <div class="form-group col-md-2 col-lg-1 text-center">
                    <label for="">@lang('admin.width')</label>
                    <input class="form-control volume-factor" type="text" name="width" id="width" placeholder="@lang('admin.width')" value="{{$category->width}}" />
                </div>
                <div class="form-group col-md-2 col-lg-1 text-center">
                    <label for="">@lang('admin.height')</label>
                    <input class="form-control volume-factor" type="text" name="height" id="height" placeholder="@lang('admin.height')" value="{{$category->height}}" />
                </div>
                <div class="form-group col-md-2 col-lg-1 text-center">
                    <label for="">@lang('admin.breadth')</label>
                    <input class="form-control volume-factor" type="text" name="breadth" id="breadth" placeholder="@lang('admin.breadth')" value="{{$category->breadth}}" />
                </div>
                <div class="form-group col-md-2 col-lg-1 text-center">
                    <label for="">@lang('admin.volume')</label>
                    <input class="form-control" type="text" name="volume" id="volume" placeholder="@lang('admin.volume')" value="{{$category->volume}}" />
                </div>
                <div class="form-group col-md-2 col-lg-1 text-center">
                    <label for="">@lang('admin.multiplier')</label>
                    <input class="form-control" type="text" name="multiplier" id="multiplier" placeholder="@lang('admin.multiplier')" value="{{$category->multiplier}}" />
                </div>
                <div class="form-group col-md-2 col-lg-1 text-center">
                    <label for="">@lang('admin.packing_volume')</label>
                    <input class="form-control" type="text" name="packing_volume" id="packing_volume" placeholder="@lang('admin.packing_volume')" value="{{$category->packing_volume}}" />
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(function()
    {
        ...
        var index = {{count($category_questions)}};
