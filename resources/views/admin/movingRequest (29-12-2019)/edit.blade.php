    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white">
                ...
                <div class="row">
                    <form action="{{ route('admin.user_request.update', $request->id) }}" method="post">
                                    ...
                                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel"
                                        ...
                                        <div class="panel-body">
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    @if($request->status == 'Pending')
                                                        <label for="start" class="col-xs-12 col-form-label">Submit
                                                            Date</label>
                                                        <div class="col-xs-12">
                                                            {{ $request->created_at }}
                                                        </div>
                                                    @else
                                                        <label for="start" class="col-xs-12 col-form-label">Booking
                                                            Date</label>
                                                        <div class="col-xs-12">
                                                ...
                                                <div class="form-group row">
                                                    <label for="type" class="col-xs-12 col-form-label">Deposit</label>
                                                    <div class="col-xs-12">
                                                        {{ $request->deposit }}
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group row">
                                                    <label for="end" class="col-xs-12 col-form-label">Status</label>
                                                    <div class="col-xs-12">
                                                ...
                                                <div class="form-group row">
                                                    <label for="end" class="col-xs-12 col-form-label">Difficulty Level</label>
                                                    <div class="col-xs-12">
                                                        {{ $request->status }}
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label for="floor" class="col-xs-12 col-form-label">Quote</label>
                                                    <div class="col-xs-12">
                                                        ${{ $request->quotation }}
                                                        <br>
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel"
                                        ...
                                        <div class="panel-body">
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label for="name"
                                                           class="col-xs-12 col-form-label">@lang('admin.name')</label>
                                                    <div class="col-xs-12">
                                                ...
                                                <div class="form-group row">
                                                    <label for="move_type" class="col-xs-12 col-form-label">Move
                                                        Type</label>
                                                    <div class="col-xs-12">
                                                ...
                                                <div class="form-group row">
                                                    <label for="email"
                                                           class="col-xs-12 col-form-label">@lang('admin.email')</label>
                                                    <div class="col-xs-12">
                                                        <input class="form-control" type="text"
                                                ...
                                                <div class="form-group row">
                                                    <label for="start" class="col-xs-12 col-form-label">Start</label>
                                                    <div class="col-xs-12">
                                                        <input class="form-control" type="text"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group row">
                                                    <label for="floor" class="col-xs-12 col-form-label">Start Floor</label>
                                                    <div class="col-xs-12">
                                                        <input class="form-control" type="text"
                                                ...
                                                <div class="form-group row">
                                                    <label for="end" class="col-xs-12 col-form-label">End</label>
                                                    <div class="col-xs-12">
                                                        <input class="form-control" type="text"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label for="floor" class="col-xs-12 col-form-label">End Floor</label>
                                                    <div class="col-xs-12">
                                                        <input class="form-control" type="text"
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xs-12 col-form-label">Inventory</label>
                                                    <div class="col-xs-12">
                                                        <a target="_blank" class="btn btn-block btn-info"
                                                           href="{{ route('admin.user_request.show', $request->id) }}">View
                                                            Inventory</a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="col-md-5">
                                                <div class="form-group row">
                                                    <div class="col-xs-6">
                                                        <label for="min"
                                                               class="col-xs-12 col-form-label">Min</label>
                                                        <input class="form-control" type="text"
                                                    ...
                                                    <div class="col-xs-6">
                                                        <label for="max"
                                                               class="col-xs-12 col-form-label">Max</label>
                                                        <input class="form-control" type="text"
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group row">
                                                    <label for="mileage"
                                                           class="col-xs-12 col-form-label">Mileage</label>
                                                    <div class="col-xs-12">
                                                        <input class="form-control" type="text"
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-xs-6">
                                                        ...
                                                        @else
                                                            ...
                                                            @else
                                                                <label for="date"
                                                                       class="col-xs-12 col-form-label">Date</label>
                                                                <input class="form-control" type="text"
                                                    ...
                                                    <div class="col-xs-6">
                                                        @if($request->date_type == "FF")
                                                            <label for="time"
                                                                   class="col-xs-12 col-form-label">Time</label>
								 ...
								 <div class="panel panel-default">
                                        ...
                                        <h4 class="panel-title">
                                            <a role="button" data-toggle="collapse" data-parent="#accordion"
                                               ...
                                               aria-expanded="true" aria-controls="collapseOne">
												...
												@if(isset($assigned_truck)) 
													Assigned  Truck
													@else  
													<font color="red">Truck Not Assigned Yet</font>
													@endif 
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                        <div class="panel-body">
                                            <div class="col-md-2">
                                                <div class="form-group row">
                                                    <label for="mileage" class="col-xs-12 col-form-label">Truck Name</label>
                                                    <div class="col-xs-12">@if(isset($assigned_truck)){{$assigned_truck->name}}@endif</div>
                                                </div>
                                            </div>
											<div class="col-md-2">
                                                <div class="form-group row">
                                                    <label for="mileage" class="col-xs-12 col-form-label">Truck Type</label>
                                                    <div class="col-xs-12">@if(isset($assigned_truck)){{$assigned_truck->type}}@endif</div>
                                                </div>
                                            </div>
											<div class="col-md-2">
                                                <div class="form-group row">
                                                    <label for="mileage" class="col-xs-12 col-form-label">Truck Color</label>
                                                    <div class="col-xs-12">@if(isset($assigned_truck)) {{$assigned_truck->color}} @endif</div>
                                                </div>
                                            </div>
											<div class="col-md-2">
                                                <div class="form-group row">
                                                    <label for="mileage" class="col-xs-12 col-form-label">Truck Volume</label>
                                                    <div class="col-xs-12">@if(isset($assigned_truck)){{$assigned_truck->volume}}@endif</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div id="collapseFour" class="panel-collapse collapse" role="tabpanel"
                                            ...
                                            <div class="panel-body">
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <label for="select2"
                                                               class="col-xs-12 col-form-label">Zone Type</label>
                                                        <input type="hidden" id="select2Val"
                                                               value="{{ $request->zonetype }}">
                                                        <div class="col-xs-12">
                                                            <select name="zonetype[]" id="select1" class="form-control select2" value="" multiple >
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <label for="select2"
                                                               class="col-xs-12 col-form-label">Vehicle Schedule</label>
                                                        <div class="col-xs-12">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <label for="select3"
                                                               class="col-xs-12 col-form-label">Vehicle Type</label>
                                                        <div class="col-xs-12">
    ...
    <script>
		...
		$(function () {
			...
			$('#calender').fullCalendar({
				...
				eventSources: [
					{
						url: '{{ route('admin.getEventsCount') }}', // use the `url` property
