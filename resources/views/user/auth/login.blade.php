            ...
            <div class="row no-margin">
                <div class="col-md-6 log-left">
                    <div class="login-logo">
                        {{-- <a href="/"><img src="{{ asset('asset/img/Capture.png') }}"></a> --}}
                    </div>
                    <h2>Create your account and get in minutes</h2>
                    <p>Welcome to  Web Portal, the easiest way to get around at the tap of a button.</p>
                </div>
                <div class="col-md-6 log-right">
                    <div class="login-box-outer">
                        <div class="login-box row no-margin">
                            ...
                            @endif
                            <form name="login_form" id="login_form" role="form" method="POST" action="{{ url('/admin/store') }}">
                                {{ csrf_field() }}
                                <div class="col-md-12">
